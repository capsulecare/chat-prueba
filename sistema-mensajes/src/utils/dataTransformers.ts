...
export const transformConversacionResumenToChatConversation = (
  ...
  const currentUser: ChatUser = {
    id: currentUserId,
    name: currentUserData.name, // ✅ USAR NOMBRE REAL
    email: '',
  ...
  const lastMessage: ChatMessage = {
    id: 0,
    senderId: resumen.idOtroUsuario,
  ...
  return {
    ...
    // ✅ CRÍTICO: SOLO INCLUIR AMBOS USUARIOS PARA QUE EL FRONTEND PUEDA IDENTIFICAR AL "OTRO"
